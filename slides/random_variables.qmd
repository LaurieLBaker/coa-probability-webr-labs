...
<iframe src="https://theonion.com/" title="The Onion" width="100%" height="100%"></iframe>

## CNN vs. the Onion Survey

Work through the hand out and take the quiz. When you are done with the quiz, let me know and I will read out the correct answers which you'll need for later steps.

```{r}
countdown::countdown(20, bottom = -1)
```

## CNN vs. the Onion in Code
...
## What might the process generating our data be?

**Bonus**

- Use `rbinom` to generate our class survey results. What should n, size be?
- Try out values for `prob` to see if you can generate something close to our data.
- Create a probability and histogram to look at the results. 
